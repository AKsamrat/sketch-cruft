      ...
      <section className="py-6 dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
          ...
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100 border-2 border-[#FA8072]">
              <img
                alt=""
              ...
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2 border-[#FA8072]">
                <a
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100  border-2 border-[#FA8072]">
              ...
              />
              <div className="flex-1 my-4">
                <p className="text-xl font-semibold leading-snug">Brad Aldis</p>
                <p>SR. Artist</p>
              </div>
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2 border-[#FA8072]">
                <a
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100 border-2 border-[#FA8072]">
              ...
              />
              <div className="flex-1 my-4">
                <p className="text-xl font-semibold leading-snug">Herla mala</p>
                <p>Craft Designer</p>
              </div>
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2 border-[#FA8072]">
                <a
